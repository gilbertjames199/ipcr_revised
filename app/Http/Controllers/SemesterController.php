...
class SemesterController extends Controller
{
    ...
    public function view_hipcr_targets2($emp_code, $ipcr_semestral_id, $type)
    {
        // dd($emp_code);
        // dd($ipcr_semestral_id);
        // dd(MonthlyTarget::with(['ipcr_Semestral.immediate.Division',
        //     'ipcr_Semestral.next_higher1.Division',
        //     'hpcrTargets',
        //     'hpcrTargets.hIPCR',
    ...
    public function view_hdpcr_targets2($emp_code, $ipcr_semestral_id, $type)
    {
        ...
        $hdpcr = MonthlyTarget::with([
            ...
            ->map(function ($groupedItems, $individual_output_id) {
                ...
                $Actual_Accomplishment = "";
                if ($individualOutput->efficiency1 == "Yes") {
                    $Actual_Accomplishment = $individualOutput->timeliness == "No" ? $individualOutput->performance_measure . " " . $individualOutput->individual_output . " with " . $quality_rating_description . " rating in efficiency, " . $efficiency_rating_description . " rating in quality/effectiveness " . $prescribed_period_description : $individualOutput->performance_measure . " " . $individualOutput->output . " with " . $quality_rating_description . " rating in efficiency, " . $efficiency_rating_description . " rating in quality/effectiveness ";
                } elseif ($individualOutput->efficiency1 == "No") {
                    $Actual_Accomplishment = $individualOutput->performance_measure . " " . $individualOutput->output . " with " . $quality_rating_description . " rating in efficiency, " . $efficiency_rating_description . " rating in quality/effectiveness " . $timeliness_description;
                } elseif ($individualOutput->efficiency1 == "No" && $individualOutput->timeliness == "No") {
                    $Actual_Accomplishment = $individualOutput->performance_measure . " " . $individualOutput->output . " with " . $quality_rating_description . " rating in efficiency, " . $efficiency_rating_description . " rating in quality/effectiveness ";
