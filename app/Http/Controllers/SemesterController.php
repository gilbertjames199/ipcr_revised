...
class SemesterController extends Controller
{
    ...
    public function data_ipcr1($emp_code, $ipcr_semestral_id, $type)
    {
        return MonthlyTarget::with([
            'ipcrTargets',
            'ipcrTargets.individualOutput',
            ...
            ->map(function ($groupedItems, $individual_output_id) {
                ...
                if ($individualOutput->efficiency1 == "Yes") {
                    $Actual_Accomplishment = $individualOutput->timeliness == "No" ? $individualOutput->performance_measure . " " . $individualOutput->individual_output . " with " . $quality_rating_description . " rating in efficiency, " . $efficiency_rating_description . " rating in quality/effectiveness " : $individualOutput->performance_measure . " " . $individualOutput->individual_output . " with " . $quality_rating_description . " rating in efficiency, " . $efficiency_rating_description . " rating in quality/effectiveness " . $prescribed_period_description;
                } elseif ($individualOutput->efficiency1 == "No" && $individualOutput->timeliness != "No") {
                    $Actual_Accomplishment = $individualOutput->timeliness == "No" ? $individualOutput->performance_measure . " " . $individualOutput->individual_output . " with " . $quality_rating_description . " rating in efficiency, " . $efficiency_rating_description . " rating in quality/effectiveness " : $individualOutput->performance_measure . " " . $individualOutput->individual_output . " with " . $quality_rating_description . " rating in efficiency, " . $efficiency_rating_description . " rating in quality/effectiveness " . $timeliness_description;
                } elseif ($individualOutput->efficiency1 == "No" && $individualOutput->timeliness == "No") {
