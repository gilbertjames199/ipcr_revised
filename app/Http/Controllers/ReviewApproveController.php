...
class ReviewApproveController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $targets_review = $this->ipcr_sem
                            ->select('ipcr__semestrals.id AS id','ipcr__semestrals.status AS status',
                                'ipcr__semestrals.year AS year','ipcr__semestrals.sem AS sem',
        ...
        $targets_prob = ProbationaryTemporaryEmployees::select(
                            'probationary_temporary_employees.id','probationary_temporary_employees.status',
                            'probationary_temporary_employees.date_from','probationary_temporary_employees.prob_status',
                            'user_employees.employee_name','user_employees.empl_id'
                        )
