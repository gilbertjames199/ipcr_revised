            ...
            <ul class="sidebar-menu scrollable pos-r">
                ...
                <li  class="nav-item dropdown" >
                    ...
                    <ul  class="dropdown-menu">
                        <li>
                            <Link class="sidebar-link" :href="`/ipcrsemestral/${$page.props.auth.user.name.id}/direct`" :class="{'active': $page.url === `/ipcrsemestral/${$page.props.auth.user.name.id}/direct`}">
                ...
                <li class="nav-item">
                    <Link class="sidebar-link" :href="`/probationary/`" :class="{'active': $page.url === '/probationary/'}">
                        <span></span>
                        <span class="icon-holder">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-check-fill" viewBox="0 0 16 16">
                                <path d="M6.5 0A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3Zm3 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3Z"/>
                        ...
                        <span class="title">Probationary/Temporary 2</span>
                    </Link>
                </li>
                <!--
                <li class="nav-item mT-30 actived">
