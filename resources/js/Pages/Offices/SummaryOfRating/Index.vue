<template>
    ...
    <div class="row gap-20 masonry pos-r">
        ...
        <div>
            <div v-if="sem_data"><b>Office: </b>
                <span v-if="sem_data[0]">
                    <u>
                        {{ sem_data[0].department }}
                    </u>
                </span>
            </div>
        </div>
            ...
            <div class="bgc-white p-20 bd">
                <div class="table-responsive">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th class="text-white text-center "
                                                            style="background-color: #727272;" colspan="2">
                                                            <h6>&nbsp;&nbsp;Summary of Ratings</h6>
                                                        </th>
                                                        <th></th>
                                                    </tr>
                                                </tbody>
                    ...
                    getMonthName(my_sem.month) }}, {{ my_sem.year }}</td>
                                                        ...
                                                        <td class="my-td text-center">
                                                            <button
                                                                @click="JanuaryAccomplishment(getMonthName(my_sem.month), sem.year, my_sem.ipcr_semestral_id, sem.department_code)"
...
export default {
    ...
    methods: {
        ...
        JanuaryAccomplishment(month, year, ipcr_semestral_id, department_code) {
            console.log(department_code)
            this.$inertia.get(
                "/summary-rating/monthly/all-offices/" + department_code,
                {
                    month: month,
                    year: year,
        ...
        SemesterRating(year, department_code, sem) {
            console.log(department_code)
            this.$inertia.get(
                "/summary-rating/semester/all-offices/" + department_code,
                {
                    year: year,
                    department_code: department_code,
                    sem: sem
