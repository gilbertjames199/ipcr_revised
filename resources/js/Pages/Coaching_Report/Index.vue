                                            ...
                                            <table class="table-responsive full-width">
                                                ...
                                                <tbody>
                                                    <tr v-for="my_sem in sem.monthly_accomplishment">
                                                        ...
                                                        <td class="my-td text-center">
                                                            <button
                                                                @click="JanuaryAccomplishment(getMonthName(my_sem.month), sem.year, sem.department_code)"
...
export default {
    ...
    methods: {
        ...
        JanuaryAccomplishment(month, year, department_code) {
