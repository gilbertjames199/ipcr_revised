    ...
    methods: {
        ...
        printSubmit1() {
            ...
            this.my_link = this.viewlink1(this.emp_code, this.auth.user.name.first_name + " " +
                ...
                this.month, this.pgHead, this.Average_Point_Core, this.Average_Point_Support, this.status);

            this.showModal1();
        },
        viewlink1(emp_code, employee_name, emp_status, position, office, division, immediate, next_higher, sem, year, idsemestral, period, pghead, Average_Score, MonthlyStatus) {
