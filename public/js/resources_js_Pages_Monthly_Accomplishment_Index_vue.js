...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    printSubmit1: function printSubmit1() {
      ...
      this.my_link = this.viewlink1(this.emp_code, this.auth.user.name.first_name + " " + mid_a + this.auth.user.name.last_name + suffix_a + post_a, this.auth.user.name.employment_type_descr, this.auth.user.name.position_long_title, this.dept.office, " ", this.month_data.imm.first_name + " " + mid_imm + this.month_data.imm.last_name + suffix_imm + post_imm, this.month_data.next.first_name + " " + mid_next + this.month_data.next.last_name + suffix_imm + post_next, this.month_data.sem, this.month_data.year, this.month_data.id, this.month, this.pgHead, this.status);
      this.showModal1();
    },
