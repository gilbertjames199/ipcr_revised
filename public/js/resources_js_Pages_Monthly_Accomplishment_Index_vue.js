      ...
      if (Array.isArray(this.data)) {
        this.data.forEach(function (item) {
          if (item.ipcr_type === 'Core Function') {
            var val = _this.AverageRate(_this.QualityRateApp(parseFloat(item.q1), parseFloat(item.q2), parseFloat(item.q3)), _this.EfficiencyRateApp(item.efficiency1 == "No" ? 0 : parseFloat(item.e1), item.efficiency2 == "No" ? 0 : parseFloat(item.e2), item.efficiency3 == "No" ? 0 : parseFloat(item.e3)), item.timeliness == "No" ? 0 : parseFloat(item.time));
      ...
      if (Array.isArray(this.data)) {
        this.data.forEach(function (item) {
          if (item.ipcr_type === 'Support Function') {
            ...
            var val = _this2.AverageRate(_this2.QualityRateApp(parseFloat(item.q1), parseFloat(item.q2), parseFloat(item.q3)), _this2.EfficiencyRateApp(item.efficiency1 == "No" ? 0 : parseFloat(item.e1), item.efficiency2 == "No" ? 0 : parseFloat(item.e2), item.efficiency3 == "No" ? 0 : parseFloat(item.e3)), item.timeliness == "No" ? 0 : parseFloat(item.time));
            // var val = this.AverageRating(item.month === 0 || item.month === null ? this.QuantityRate(item.quantity_type, item.TotalQuantity, 1) : this.QuantityRate(item.quantity_type, item.TotalQuantity, item.month), this.QualityRate(item.quality_error, this.quality_score(item.total_quality,item.quality_error)), item.TimeRating == "" ? 0 : item.TimeRating);
            // num_of_data += 1;
            // sum += parseFloat(val);
            // average = sum / num_of_data
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Head, null, {
    ...
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(dat.individual_output), 9 /* TEXT, PROPS */, _hoisted_16), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(dat.efficiency1 == "Yes" ? dat.performance_measure + " " + dat.individual_output + " with a satisfactory rating for quality/effectiveness and satisfactory in efficiency within " + dat.prescribed_period : dat.performance_measure + " " + dat.individual_output + " with a satisfactory rating for quality/effectiveness and satisfactory in efficiency on or before " + dat.timeliness), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.QualityRateApp(dat.q1, dat.q2, dat.q3)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.EfficiencyRateApp(dat.efficiency1 == "No" ? 0 : parseFloat(dat.e1), dat.efficiency2 == "No" ? 0 : parseFloat(dat.e2), dat.efficiency3 == "No" ? 0 : parseFloat(dat.e3))), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(dat.timeliness == "No" ? "Not to be Rated" : dat.time == null || dat.time == "" ? 0 : dat.time) + " ", 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" {{ dat.timeliness }} 9 ")]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.AverageRateApp(_ctx.QualityRateApp(parseFloat(dat.q1), parseFloat(dat.q2), parseFloat(dat.q3)), _ctx.EfficiencyRateApp(dat.efficiency1 == "No" ? 0 : parseFloat(dat.e1), dat.efficiency2 == "No" ? 0 : parseFloat(dat.e2), dat.efficiency3 == "No" ? 0 : parseFloat(dat.e3)), dat.timeliness == "No" ? 0 : dat.time)), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_60, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("iframe", {
        src: $data.my_link,
        style: {
          "width": "100%",
          "height": "450px"
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      }, "Add Remarks")])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_63, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        "class": "btn btn-primary btn-sm mL-2 text-white",
