  ...
  methods: {
    ...
    getAfter10thWorkingDay: function getAfter10thWorkingDay(year, month) {
      ...
      var _loop = function _loop() {
          ...
          return {
            v: (record === null || record === void 0 ? void 0 : record.allow_month_backtrack) === "1"
          };
        },
        _ret;
      while (count < 10) {
