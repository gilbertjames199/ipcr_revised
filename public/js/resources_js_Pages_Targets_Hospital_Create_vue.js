    ...
    selected_pcr: function selected_pcr() {
      ...
      setTimeout(function () {
        if (String(_this2.form.idPCR) !== null && String(_this2.form.idPCR) !== undefined && String(_this2.form.idPCR) !== '') {
          ...
          _this2.pcr_performance = _this2.pcrs[index].efficiency1 == "No" && _this2.pcrs[index].timeliness == "No" ? _this2.pcrs[index].performance_measure + " " + _this2.pcrs[index].individual_output + " with a satisfactory rating for quality/effectiveness and satisfactory in efficiency" : _this2.pcrs[index].efficiency1 == "Yes" ? _this2.pcrs[index].performance_measure + " " + _this2.pcrs[index].individual_output + " with a satisfactory rating for quality/effectiveness and satisfactory in efficiency within " + _this2.pcrs[index].prescribed_period : _this2.pcrs[index].performance_measure + " " + _this2.pcrs[index].individual_output + " with a satisfactory rating for quality/effectiveness and satisfactory in efficiency on or before " + _this2.pcrs[index].timeliness;
